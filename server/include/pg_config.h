...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=/opt/homebrew/Cellar/postgresql/14.2_1' '--datadir=/opt/homebrew/share/postgresql' '--libdir=/opt/homebrew/lib' '--includedir=/opt/homebrew/include' '--sysconfdir=/opt/homebrew/etc' '--docdir=/opt/homebrew/Cellar/postgresql/14.2_1/share/doc/postgresql' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-openssl' '--with-pam' '--with-perl' '--with-uuid=e2fs' '--with-bonjour' '--with-tcl' 'PG_SYSROOT=/Library/Developer/CommandLineTools/SDKs/MacOSX12.sdk' 'CC=clang' 'LDFLAGS=-L/opt/homebrew/opt/openssl@1.1/lib -L/opt/homebrew/opt/readline/lib' 'CPPFLAGS=-I/opt/homebrew/opt/openssl@1.1/include -I/opt/homebrew/opt/readline/include' 'CXX=clang++' 'PKG_CONFIG_PATH=/opt/homebrew/opt/icu4c/lib/pkgconfig:/opt/homebrew/opt/openssl@1.1/lib/pkgconfig:/opt/homebrew/opt/krb5/lib/pkgconfig:/opt/homebrew/opt/readline/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/12'"
